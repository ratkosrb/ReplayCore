...
public:
    ...
    bool m_onlyShowRealSpawns = false;
...
public:
    ...
    void SendSpellCastStart(uint32 spellId, uint8 castCount, uint32 castTime, uint32 castFlags, ObjectGuid casterGuid, ObjectGuid unitCasterGuid, WorldObject const* pTarget, uint32 ammoDisplayId = 0, uint32 ammoInventoryType = 0);
    void SendSpellCastStart(uint32 spellId, uint8 castCount, uint32 castTime, uint32 castFlags, ObjectGuid casterGuid, ObjectGuid unitCasterGuid, SpellCastTargets const& targets, uint32 ammoDisplayId = 0, uint32 ammoInventoryType = 0);
    void SendCastResult(uint32 spellId, uint32 result, uint32 reason);
    void SendSpellCastGo(uint32 spellId, uint8 castCount, uint32 castFlags, ObjectGuid casterGuid, ObjectGuid unitCasterGuid, SpellCastTargets const& targets, std::vector<std::pair<ObjectGuid, uint8>> const& vHitTargets, std::vector<std::pair<ObjectGuid, uint8>> const& vMissTargets, uint32 ammoDisplayId = 0, uint32 ammoInventoryType = 0);
