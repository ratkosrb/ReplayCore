...
#define MAX_ITEM_PROTO_DAMAGES_VANILLA 5
#define MAX_ITEM_PROTO_DAMAGES_WOTLK 2
...
struct ItemPrototype
{
    ...
    uint32 ScalingStatDistribution = 0;                      // id from ScalingStatDistribution.dbc
    uint32 ScalingStatValue = 0;                             // mask for selecting column in ScalingStatValues.dbc
    uint32 Delay = 0;
    float  RangedModRange = 0;
    uint32 AmmoType = 0;
    _ItemDamage Damage[MAX_ITEM_PROTO_DAMAGES_VANILLA];
    uint32 Block = 0;
    int32 Armor = 0;
    int32 HolyRes = 0;
    int32 FireRes = 0;
    ...
    uint32 RandomSuffix = 0;                                // id from ItemRandomSuffix.dbc
    ...
    uint32 Duration = 0;
    uint32 BagFamily = 0;
    uint32 TotemCategory = 0;                               // id from TotemCategory.dbc
    _Socket Socket[MAX_ITEM_PROTO_SOCKETS];
    uint32 socketBonus = 0;                                 // id from SpellItemEnchantment.dbc
    uint32 GemProperties = 0;                               // id from GemProperties.dbc
    int32 RequiredDisenchantSkill = 0;
    float  ArmorDamageModifier = 0;
    uint32 ItemLimitCategory = 0;                           // id from ItemLimitCategory.dbc
    uint32 HolidayId = 0;                                   // id from Holidays.dbc
