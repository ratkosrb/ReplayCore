...
std::map<std::string, uint16> Opcodes::g_opcodeValues5875 =
{
    ...
    { "SMSG_TANCE_SAVE_CREATED", 715 },
    { "SMSG_RAID_TANCE_INFO", 716 },
    ...
    { "CMSG_RESET_TANCES", 797 },
    { "SMSG_TANCE_RESET", 798 },
    { "SMSG_TANCE_RESET_FAILED", 799 },
    { "SMSG_UPDATE_LAST_TANCE", 800 },
...
std::map<std::string, uint16> Opcodes::g_opcodeValues12340 =
{
    ...
    { "SMSG_OPEN_CONTAINER", 275 },
    { "CMSG_INSPECT", 276 },
    { "SMSG_INSPECT_RESULTS_UPDATE", 277 },
    { "CMSG_INITIATE_TRADE", 278 },
    { "CMSG_BEGIN_TRADE", 279 },
    { "CMSG_BUSY_TRADE", 280 },
    { "CMSG_IGNORE_TRADE", 281 },
    ...
    { "CMSG_ATTACK_SWING", 321 },
    { "CMSG_ATTACK_STOP", 322 },
    { "SMSG_ATTACK_START", 323 },
    { "SMSG_ATTACK_STOP", 324 },
